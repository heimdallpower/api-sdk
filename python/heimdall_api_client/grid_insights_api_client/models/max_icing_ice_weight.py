...
T = TypeVar("T", bound="MaxIcingIceWeight")


@_attrs_define
class MaxIcingIceWeight:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        max_icing_ice_weight.additional_properties = d
        return max_icing_ice_weight
