...
T = TypeVar("T", bound="MaxIcingTensionPercentageOfBreakStrength")


@_attrs_define
class MaxIcingTensionPercentageOfBreakStrength:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        max_icing_tension_percentage_of_break_strength = cls(
            timestamp=timestamp,
            span_phase_id=span_phase_id,
            value=value,
            unit=unit,
        ...
        max_icing_tension_percentage_of_break_strength.additional_properties = d
        return max_icing_tension_percentage_of_break_strength
