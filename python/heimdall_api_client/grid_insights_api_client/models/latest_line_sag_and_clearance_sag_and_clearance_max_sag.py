...
T = TypeVar("T", bound="LatestLineSagAndClearanceSagAndClearanceMaxSag")


@_attrs_define
class LatestLineSagAndClearanceSagAndClearanceMaxSag:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        latest_line_sag_and_clearance_sag_and_clearance_max_sag = cls(
            timestamp=timestamp,
            span_phase_id=span_phase_id,
            value=value,
            unit=unit,
        ...
        latest_line_sag_and_clearance_sag_and_clearance_max_sag.additional_properties = d
        return latest_line_sag_and_clearance_sag_and_clearance_max_sag
