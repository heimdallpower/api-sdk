...
if TYPE_CHECKING:
    from ..models.span_phase_current import SpanPhaseCurrent


T = TypeVar("T", bound="SpanCurrent")
...
class SpanCurrent:
    ...
    Attributes:
        ...
        span_phases (list[SpanPhaseCurrent]): List of span phases (conductors) within this span.
    """

    span_id: UUID
    span_phases: list[SpanPhaseCurrent]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for span_phases_item_data in _span_phases:
            span_phases_item = SpanPhaseCurrent.from_dict(span_phases_item_data)
        ...
        span_current.additional_properties = d
        return span_current
