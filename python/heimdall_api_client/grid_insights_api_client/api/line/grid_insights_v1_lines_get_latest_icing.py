...
from ...models.grid_insights_v1_lines_get_latest_icing_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    x_region: Union[Unset, GridInsightsV1LinesGetLatestIcingXRegion] = GridInsightsV1LinesGetLatestIcingXRegion.EU,
) -> dict[str, Any]:
...
) -> Optional[Union[Any, GridInsightsV1LinesGetLatestIcingResponse200, ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GridInsightsV1LinesGetLatestIcingResponse200, ProblemDetails]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        x_region (Union[Unset, GridInsightsV1LinesGetLatestIcingXRegion]): Default:
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GridInsightsV1LinesGetLatestIcingResponse200, ProblemDetails]
    """
