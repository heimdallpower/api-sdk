namespace HeimdallPower.Api.Client.REST.CapacityMonitoring.Lines.Forecasts;
...
public record HeimdallDlrForecastResponse
{
    ...
    /// </summary>
    public required IReadOnlyCollection<ForecastDto> HeimdallDlrForecasts { get; init; }
}
