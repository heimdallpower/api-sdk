...
/// <param name="Metric">The kind of event carried in <paramref name="Data"/>, e.g. <see cref="HeimdallDlrEvent.MetricName"/>.</param>
    ...
    JsonElement Data)
{
    ...
    /// Only meaningful when <see cref="Metric"/> equals <see cref="HeimdallDlrEvent.MetricName"/>.
    /// </summary>
