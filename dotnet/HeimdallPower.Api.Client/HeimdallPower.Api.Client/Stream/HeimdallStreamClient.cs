...
public class HeimdallStreamClient : IHeimdallStreamClient
{
    ...
    /// <summary>
    /// Streams events for the authenticated grid owner with the specified quantity, transparently reconnecting with exponential backoff when the
        ...
        [EnumeratorCancellation] CancellationToken token = default)
    {
        ...
        while (!token.IsCancellationRequested)
        {
            ...
            await using var enumerator = ConnectAndReadAsync(quantity, traceLogger, token)
